...
public class GlobalSeleniumLibrary {
	...
	public List<String> automaticallyAttachErrorImgToEmail() {
		...
		File file = new File("target/screenshots"); // first check if
													// error-screenshot folder
													// has file
		if (file.isDirectory()) {
	...
	/*
	 * public static void main(String[] args) { GlobalSeleniumLibrary myLib =
	 * new GlobalSeleniumLibrary(null); myLib.getCurrentTime(); }
	 */
